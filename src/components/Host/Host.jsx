...
const Host = () => {
    return (
        <div className='bg-[#7a4af9] max-w-6xl h-[574px] flex items-center p-10 gap-10 text-white'>
            ...
            <div>
                ...
                <p className='flex items-center mt-4 mb-1'><Image src={check} className='' alt='check' /> Host Your Event With Easy steps</p>
                <p className='flex items-center mt-4 mb-1'><Image src={check} className='' alt='check' /> Host Your Event With Easy steps</p>
                <p className='flex items-center mt-4 mb-1'><Image src={check} className='' alt='check' /> Host Your Event With Easy steps</p>
                <p className='flex items-center mt-4 mb-1'><Image src={check} className='' alt='check' /> Host Your Event With Easy steps</p>
            </div>
