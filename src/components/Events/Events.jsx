...
const Events = () => {
    return (
        <div className='text-black bg-gray-100'>
            <h2 className='text-3xl flex mt-10 justify-center font-semibold'>Events</h2>
...
<div className="card-body">
        ...
        <div className='flex'>
            <div>
            <p className="badge badge-primary bg-[#7a4af9] text-white mb-3">Music</p>
<p className='text-sm flex items-center mb-4'><CiLocationOn /> Celebrity Convention Hall</p>
        <h2 className="card-title text-black ">Roufian&apos;s HSC-24 Rag <br /> Day</h2>
            </div>
            <div className='flex flex-col items-center'>
                <span>Apr</span> <span className='text-4xl text-[#7a4af9] font-semibold'>20</span> <span>10:00 PM</span>
            </div>
        </div>
        ...
        <button className="p-2 rounded-md  bg-[#7a4af9] hover:bg-[#7a4af9] text-white font-normal mr-5">
                                ...
                                See Ticket</span></button>
                                <div className='flex items-center'>
                                    <span className='text-2xl text-[#7a4af9] font-semibold'>20</span> <span className='flex flex-col'>Seat <span>Left</span></span>
                                </div>
