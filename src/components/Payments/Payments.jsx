...
const Payments = () => {
    return (
        <div>
            <div className='text-black mt-10 mb-32 overflow-hidden flex mx-auto items-center bg-gradient-to-b from-white via-white to-[#F1F3FF] flex-col    w-[1160px] rounded-xl h-[700px] '>
                ...
                <div className="bg-[#7a4af9] flex text-white btn hover:bg-[#7a4af9] mt-2">
                    ...
                    <div className="flex gap-6 mt-12 relative">
                        ...
                        <div  className="w-[360px] h-[513px] bg-[#8C3494]    absolute rounded-3xl right-64     z-10 top-28">
...
<Image src={rocketPay} alt="rocket" className="  mt-36" />
                        ...
                        <div className="w-[360px] h-[513px] bg-green-700 bg-gradient-to-t from-[#ED1C24] top-28 rounded-3xl to-[#F7941D]     absolute left-64 z-10">
                            <div  className="flex  flex-col justify-center items-center ">
